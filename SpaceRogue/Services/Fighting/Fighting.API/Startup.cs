...
using Cope.SpaceRogue.Fighting.API.Infrastructure;
	...
	public class Startup
	{
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapGrpcService<FightingService>();
            });
        ...
        private void ConfigureEventBus(IApplicationBuilder app)
        {
            ...
            eventBus.Subscribe<ObjectInSensorRangeIntegrationEvent, ObjectInSensorRangeIntegrationEventHandler>();
        }
    }
    ...
    static class CustomExtensionsMethods
    {
        ...
        public static IServiceCollection AddCustomMvc(this IServiceCollection services)
        {
            ...
            services.AddControllers(options =>
            {
                ...
                .AddApplicationPart(typeof(FightController).Assembly)
                .AddNewtonsoftJson()
