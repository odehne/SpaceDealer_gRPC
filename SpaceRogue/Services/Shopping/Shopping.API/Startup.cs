...
using Cope.SpaceRogue.Shopping.API.Infrastructure;
using Cope.SpaceRogue.Shopping.API.Services;
using Cope.SpaceRogue.Shopping.API.Application.IntegrationEvents;
using Cope.SpaceRogue.Shopping.API.Repositories;
using Cope.SpaceRogue.Shopping.API.Controllers;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapGrpcService<ShoppingService>();
            });
